...
const filter = RuleFactory('cd1c6c33-1f90-41dc-aa97-dc2ba3ae65b7', 'ViewFilter');
const WithStatusBuilder = StatusBuilderAnnotationFactory('programEncounter', 'formElement');

const pncDecision = RuleFactory("cd1c6c33-1f90-41dc-aa97-dc2ba3ae65b7", "Decision");

@filter('38a91383-274b-4e6a-923c-5cce02c76c33', 'ChildPNCHandlerClusterIncharge', 100.0)
class ChildPNCHandlerClusterIncharge {
    static exec(programEncounter, formElementGroup, today) {
        return FormElementsStatusHelper
            .getFormElementsStatusesWithoutDefaults(new ChildPNCHandlerClusterIncharge(), programEncounter, formElementGroup, today);
    }
...
@pncDecision("df79f019-8b7e-409a-8800-64f8e4c940b8", "PNC Cluster Incharge Decisions", 100)
class PncDecisionClusterIncharge {
    static exec(programEncounter, decisions, context, today) {
        decisions.encounterDecisions.push(PncDecisionClusterIncharge.counseling(programEncounter));
        decisions.encounterDecisions.push(PncDecisionClusterIncharge.referToHospital(programEncounter));
        return decisions;
    }
...
module.exports = {ChildPNCHandlerClusterIncharge, PncDecisionClusterIncharge};