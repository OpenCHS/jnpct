...
export class FollowDecisions {
    static exec(programEncounter, decisions, context, today) {
        followupDecisions(programEncounter, decisions, context, today);
    }    
}

@followupDecisionClusterIncharge("0b3a820e-369f-4a7a-a54b-bc44ef13a31e", "Follow Up Decision Cluster Incharge", 100)
export class FollowDecisionsClusterIncharge {
    static exec(programEncounter, decisions, context, today) {
        followupDecisions(programEncounter, decisions, context, today);
    }    
}

const followupDecisions = (programEncounter, decisions, context, today) => {
    ...
    decisions.encounterDecisions.push(referToHospital(programEncounter));
    // console.log('decisions',decisions);
    return decisions;
}

const referToHospital = (programEncounter) => {
