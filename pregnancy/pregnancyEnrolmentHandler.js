...
@EnrolmentEligibilityCheck({
    name: 'PregnancyEligibility',
    uuid: '23f5e975-9cf3-4a51-ab99-7adf32254067',
    programUUID: '26d3e45e-7174-433f-b4a7-db1524648252',
    executionOrder: 100.0,
    metadata: {}
})
class PregnancyEligibility {
...
module.exports = {PregnancyEnrolmentViewFilterHandlerJNPCT, PregnancyFormDecisionHandler, PregnancyEligibility};
